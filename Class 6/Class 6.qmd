---
title: "Class 06: R Studio Functions"
...
_ Input **arguements** , there can be multiple comma seperated inputs to the function.
...
```
Make a third function that generates a protein sequence of a user unspecified length and format.
...
- One approach is to do this with brute force calling our function for each length between 5 and 12
